 ...
 */
      ...
      if ( this.state.selectedProjectIndex !== null && this.state.selectedProjectIndex !== undefined ) { 
        if ( this.state.selectedProjectIndex > -1 ) { hasProject = true ; testUpdate += this.state.selectedProject ? this.state.selectedProject.titleProject : 'unkTitle'; }
      }
...
// was     .select(selectColsProj).expand(expandTheseProj).filter(projectRestFilter).orderBy(projectSort,true).inBatch(batch).getAll()
