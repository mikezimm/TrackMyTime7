...
export const statusChoices = [defStatus, planStatus, processStatus, `3. Verify`, parkStatus, cancelStatus, completeStatus];
 ...
 */
  ...
  public render(): React.ReactElement<ITrackMyTime7Props> {
    ...
    const showProjectScreen = this.state.dialogMode ;
 ...
 */
    ...
    if (showProjectScreen == TMTDialogMode.New  || showProjectScreen == TMTDialogMode.Edit  || showProjectScreen == TMTDialogMode.Copy ) {

      let selectedProject: IProject = null;
      
      if ( showProjectScreen === TMTDialogMode.New ) { selectedProject = this.createEmptyProjectObject(); }
      else if ( showProjectScreen === TMTDialogMode.Copy ) {
      ...
      let projectPage = <MyProjectPage 
        ...
        showProjectScreen={ this.state.dialogMode }
 ...
 */
        ...
        },*/
  {
      ...
      } else if ( this.state.dialogMode == TMTDialogMode.New || this.state.dialogMode == TMTDialogMode.Copy || this.state.dialogMode == TMTDialogMode.Edit ) {
